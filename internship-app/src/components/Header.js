...
//import {logo} from '../images/intern_logo.png';
...
function Header(){
  ...
  React.useEffect(() => {
    ...
    return(
        ...
        <div className='logo'><img src={`${process.env.PUBLIC_URL}/images/intern_logo.png`} alt='logo'/></div>
        {innerWidth >= 635 && <nav>
        ...
        <Link to="/Page1" title="Task1: Responsive Landing Page">Home</Link>
